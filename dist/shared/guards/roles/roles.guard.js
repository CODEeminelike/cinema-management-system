...
let RolesGuard = RolesGuard_1 = class RolesGuard {
    reflector;
    logger = new common_2.Logger(RolesGuard_1.name);
    ...
    canActivate(context) {
        ...
        if (!hasRole) {
            this.logger.warn(`User role ${user.role} does not match required roles: ${requiredRoles.join(', ')}`);
            throw new common_1.ForbiddenException('Vai trò không phù hợp');
        }
